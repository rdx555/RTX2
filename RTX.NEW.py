...
\033[1;37m------------------------------------------------🍁
\033[1;37m Owner          =:      RAAZ/TOHA
\033[1;37m Facebook    =:      Min Has
\033[1;37mWhatsApp    =:      01405199968
\033[1;37m Github          =:      Minhaz404
\033[1;37m Version        =:       1.9.0.5
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/mario.gambatesa.5')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back RTX Raaz ")
    SSB(allkey)       
